...
urlpatterns = [
    ...
    path('impact/export-pptx/', views_impact.export_impact_report_pptx, name='export_impact_report_pptx'),
    path('impact/export-social-card/', views_impact.export_impact_social_card_png, name='export_impact_social_card_png'),
    path('impact/export-infographic/', views_impact.export_impact_infographic_png, name='export_impact_infographic_png'),
