...
def export_foodbank_donations_received_csv(request):
    ...
    for donation in donations:
        ...
        item_desc = donation.item_name or donation.subsidized_product_type or donation.csr_description or 'N/A'
        quantity = f"{donation.quantity} {donation.quantity_unit}" if donation.quantity else (
            f"{donation.subsidized_quantity} {donation.subsidized_quantity_unit}" if donation.subsidized_quantity else 'N/A'
        )
        amount = f"{donation.amount}" if donation.amount else (
            f"{donation.subsidized_price}" if donation.subsidized_price else 'N/A'
        )
